    ...
    return(
        <div class="aboutWrapper">
            ...
            <div class="aboutRight">
                ...
                <div class="icons">
                    <a target="_blank" aria-label="Instagram" href="https://www.instagram.com"><FontAwesomeIcon icon={faInstagram}/></a>
                    <a target="_blank" aria-label="Pinterest" href="https://ar.pinterest.com"><FontAwesomeIcon icon={faPinterest} /></a>
                    <a target="_blank" aria-label="Twitter" href="https://twitter.com"><FontAwesomeIcon icon={faTwitter} /></a>
                </div>
            </div>
        </div>
    )
